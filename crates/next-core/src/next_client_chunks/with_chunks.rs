...
use turbopack_core::{
    ...
    chunk::{
        ChunkGroupVc, ChunkItem, ChunkItemVc, ChunkListReferenceVc, ChunkVc, ChunkableAsset,
...
impl WithChunksChunkItemVc {
    ...
    async fn chunk_list_path(self) -> Result<FileSystemPathVc> {
        ...
        Ok(this
            .inner_context
            .chunk_path(this.inner.path().join("chunk-list.json"), ".json"))
    }
